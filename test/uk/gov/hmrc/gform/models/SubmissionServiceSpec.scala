...
class SubmissionServiceSpec extends FlatSpec with Matchers with EitherValues {
  ...
  val formData = Form(FormId("anId"), FormData(FormTypeId("ftid"), Version("version"), "charset", data.values.toSeq), EnvelopeId(""))
  ...
  it should "return a Left if formData is missing" in {
    ...
    val formDataWithoutRequiredField = Form(FormId("anId"), FormData(FormTypeId("ftid"), Version("version"), "charset", (data - FieldId("startDate.month")).values.toSeq), EnvelopeId(""))
  ...
  it should "not complain if formData is present for fields on included Sections" in {
    ...
    val formDataWithoutFieldsOnExludedSection = Form(FormId("anId"), FormData(FormTypeId("ftid"), Version("version"), "charset", (data - FieldId("startDate.month")).values.toSeq), EnvelopeId(""))
  ...
  it should "return only the formData on included Sections" in {
    ...
    val dataForAllFormFields = Form(FormId("anId"), FormData(FormTypeId("ftid"), Version("version"), "charset", data.values.toSeq), EnvelopeId(""))
