...
object FileUploadDemoApp extends App {
  ...
  val configQAProxiedByGform = configLocal.copy(
    fileUploadBaseUrl = "https://www-qa.tax.service.gov.uk/submissions/test-only/proxy-to-file-upload",
    fileUploadFrontendBaseUrl = "https://www-qa.tax.service.gov.uk"
  )

  val config = configQAProxiedByGform
