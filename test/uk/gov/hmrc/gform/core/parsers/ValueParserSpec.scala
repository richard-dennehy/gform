...
class ValueParserSpec extends Spec {
  ...
  val plainFormTemplate = FormTemplate(FormTemplateId("IPT100"), "Insurance Premium Tax Return", "description", "characterSet", DmsSubmission("nino", "BT-NRU-Environmental", "FinanceOpsCorpT"), "submitSuccessUrl", "submitErrorUrl", List.empty[Section])
